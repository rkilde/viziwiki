      ...
      if (type === 'config') {
        ...
        qsa('.cfg-row', secEl).forEach(function (row) {
          ...
          drawer.innerHTML =
            ...
            + '<span class="dr-info" tabindex="0" data-tip="' + ea("Sets a model apart from the standard tiers: it drops below a hairline divider with a striped bar. Use it when a config doesn't belong in the main lineup. Example — a device launches with 32, 128 & 256 GB. A year later the maker quietly reissues the 32 GB at a lower price while the original three stay on sale. Marking that reissue 'special' stops it from reading as a fourth original tier; it clearly shows as the separate, later variant.") + '"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg></span>'
            + '</div>'
